    ...
    return (
        <main className="min-h-screen bg-[#fbfaf8] text-[#211b16]">
            ...
            <section className="px-5 py-8 sm:px-6 lg:px-10">
                <form action={formAction} className="mx-auto max-w-6xl rounded-lg border border-[#ded4c8] bg-white/78 p-6 shadow-[0_18px_55px_rgba(70,54,36,0.08)] sm:p-8 lg:p-10">
