...
import { deleteSubmitApplication } from '@/lib/actions';
import { Trash2 } from 'lucide-react';
import { useRouter } from 'next/navigation';
import { useState, useTransition } from 'react';

export default function DeleteSubmitApplicationButton({ id }: { id: number }) {
    ...
    const handleDelete = () => {
        startTransition(async () => {
            const result = await deleteSubmitApplication(id);
